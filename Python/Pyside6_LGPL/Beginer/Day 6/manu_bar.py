...
window = QMainWindow()
window.setWindowTitle('Menu Bar Example')
...
# Step 9: Connect the Exit action to close the window
exit_action.triggered.connect(window.close)

# Step 10: Show the main window
window.show()

# Step 11: Run the application's event loop
sys.exit(app.exec())
