...
from OpenGL.GL import glClear, glClearColor, glBegin, glEnd, glVertex2f, GL_TRIANGLES, GL_COLOR_BUFFER_BIT
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('QOpenGLWidget Triangle Example')
        self.resize(800, 600)
